...
class SmartEnvironment extends StatefulWidget {
  ...
  @override
  State<SmartEnvironment> createState() => _SmartGovernanceState();
}

class _SmartGovernanceState extends State<SmartEnvironment> {
  ...
  void initState() {
    super.initState();
    filteredServices = SmartEnvironment.allServices;
